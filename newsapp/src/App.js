  ...
  render() {
    return (
     ...
     progress={this.state.progress}/>
          ...
          <Routes>
            <Route exact path="/" element={<News setProgress={this.setProgress} key="health" pageSize={this.pageSize} country="us" category="general" />} />
            ...
            <Route exact path="/health" element={<News setProgress={this.setProgress} key="general" pageSize={this.pageSize} country="us" category="health" />} />
