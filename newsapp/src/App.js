    ...
    return (
      <div>
        <Router>
          <Navbar />
          <Routes>
            <Route exact path="/" element={<News key="health" pageSize={this.pageSize} country="us" category="general" />} />
            ...
            <Route exact path="/health" element={<News key="general" pageSize={this.pageSize} country="us" category="health" />} />
